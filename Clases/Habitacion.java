 ...
 *
 *  numHabitacion Es el número de la habitación dentro del hotel, usualmente de 3 ó 4 cifras donde las dós ultimas determinan el número de habitación en el piso y la o las primeras el número de piso.
 *  capacidad Determina la cantidad máxima de personas que la habitación puede albergar.
 *  tipo Descripción del tipo de habitación que se trata.
 *  precioDiario Es el costo diario por alquilar la habitación.
 *  frigobar Es un objeto de la clase frigobar que representa al frigobar que cada habitación posee.
 *  ColecIntervalosDeFechas Es una colección que posee intervalos de fechas en los que la habitación por alguna razón no se encuentra disponible para ser ocupada por un huesped.
 *
 */
